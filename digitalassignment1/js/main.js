class MyScene extends Phaser.Scene 
{
    ...
    preload ()
    {
        this.load.spritesheet('mothership', 'assets/mothership.png', { frameWidth: 32, frameHeight: 32 });
        this.load.spritesheet('boom', 'assets/explosion.png', { frameWidth: 64, frameHeight: 64, endFrame: 23 });
    }

    create ()
    {
        this.add.text(400, 32, 'Click the mothership to destroy them', { color: '#00ff00' }).setOrigin(0.5, 0);
        ...
        for (var i = 0; i < 128; i++)
        {
            ...
            var ship = this.add.sprite(x, y, 'mothership');
